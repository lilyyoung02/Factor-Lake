...
class P2B(Factors):
    def get(self, ticker, market):
        ...
        try:
            ...
            log(f"Error accessing Price to Book Using 9/30 Data for {ticker}: {e}", level = "DEBUG")
            return None
...
class OneYrPriceVol(Factors):
    def get(self, ticker, market):
        ...
        try:
            ...
            log(f"Error accessing 1-Yr Price Vol % for {ticker}: {e}", level = "DEBUG")
            return None
...
class AccrualsAssets(Factors):
    def get(self, ticker, market):
        ...
        try:
            ...
            log(f"Error accessing Accruals/Assets % for {ticker}: {e}", level = "DEBUG")
            return None
...
class ROAPercentage(Factors):
    def get(self, ticker, market):
        ...
        try:
            ...
            log(f"Error accessing ROA % for {ticker}: {e}", level = "DEBUG")
            return None
...
class OneYrAssetGrowth(Factors):
    def get(self, ticker, market):
        ...
        try:
            ...
            log(f"Error accessing 1-Yr Asset Growth % for {ticker}: {e}", level = "DEBUG")
            return None
...
class OneYrCapEXGrowth(Factors):
    def get(self, ticker, market):
        ...
        try:
            ...
            log(f"Error accessing 1-Yr CapEX Growth % for {ticker}: {e}", level = "DEBUG")
            return None
...
class BookPrice(Factors):
    def get(self, ticker, market):
        ...
        try:
            ...
            log(f"Error accessing Book/Price for {ticker}: {e}", level = "DEBUG")
            return None
...
class NextYrReturn(Factors):
    def get(self, ticker, market):
        ...
        try:
            ...
            log(f"Error accessing Next-Year's Return % for {ticker}: {e}", level = "DEBUG")
            return None
